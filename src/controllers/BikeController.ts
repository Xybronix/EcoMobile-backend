...
export class BikeController {
   ...
   */
  async getAvailableBikes(req: Request, res: Response): Promise<void> {
    try {
      const page = parseInt(req.query.page as string) || 1;
      const limit = parseInt(req.query.limit as string) || 20;
   ...
   */
  async getNearbyBikes(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  async getDefaultAreas(_req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  async searchAreas(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  async syncGpsData(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  async getBikeTrack(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
   ...
   */
  async getBikeMileage(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
      const { startTime, endTime } = req.query;
   ...
   *         description: Bike retrieved
   */
  async getBikeByCode(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  async updateBike(req: Request, res: Response) {
    try {
      const { id } = req.params;
   ...
   */
  async unlockBike(req: Request, res: Response) {
    try {
      const { id } = req.params;
   ...
   */
  async lockBike(req: Request, res: Response) {
    try {
      const { id } = req.params;
   ...
   */
  async getBikeTrips(req: Request, res: Response) {
    try {
      const { id } = req.params;
