...
export class AuthController {
   ...
   */
  register = asyncHandler(async (req: AuthRequest, res: express.Response) => {
   ...
   */
  login = asyncHandler(async (req: AuthRequest, res: express.Response) => {
    const language = req.language || 'fr';
   ...
   */
  me = asyncHandler(async (req: AuthRequest, res: express.Response) => {
    const language = req.language || 'fr';
   ...
   */
  updateProfile = asyncHandler(async (req: AuthRequest, res: express.Response) => {
    const language = req.language || 'fr';
    const userId = req.user!.id;
   ...
   */
  getSessions = asyncHandler(async (req: AuthRequest, res: express.Response) => {
    const language = req.language || 'fr';
    const userId = req.user!.id;
   ...
   */
  disconnectSession = asyncHandler(async (req: AuthRequest, res: express.Response) => {
    const language = req.language || 'fr';
    const userId = req.user!.id;
   ...
   */
  disconnectAllSessions = asyncHandler(async (req: AuthRequest, res: express.Response) => {
    const language = req.language || 'fr';
    const userId = req.user!.id;
   ...
   */
  forgotPassword = asyncHandler(async (req: AuthRequest, res: express.Response) => {
    const language = req.language || 'fr';
   ...
   */
  resetPassword = asyncHandler(async (req: AuthRequest, res: express.Response) => {
    const language = req.language || 'fr';
   ...
   */
  changePassword = asyncHandler(async (req: AuthRequest, res: express.Response) => {
    const language = req.language || 'fr';
   ...
   */
  validateToken = asyncHandler(async (req: AuthRequest, res: express.Response) => {
    res.status(200).json({
      success: true,
