...
-- AddForeignKey
ALTER TABLE `rides` ADD CONSTRAINT `rides_bikeId_fkey` FOREIGN KEY (`bikeId`) REFERENCES `bikes`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `maintenance_logs` ADD CONSTRAINT `maintenance_logs_bikeId_fkey` FOREIGN KEY (`bikeId`) REFERENCES `bikes`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `incidents` ADD CONSTRAINT `incidents_bikeId_fkey` FOREIGN KEY (`bikeId`) REFERENCES `bikes`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `pricing_plans` ADD CONSTRAINT `pricing_plans_pricingConfigId_fkey` FOREIGN KEY (`pricingConfigId`) REFERENCES `pricing_configs`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `pricing_rules` ADD CONSTRAINT `pricing_rules_pricingConfigId_fkey` FOREIGN KEY (`pricingConfigId`) REFERENCES `pricing_configs`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `promotions` ADD CONSTRAINT `promotions_pricingConfigId_fkey` FOREIGN KEY (`pricingConfigId`) REFERENCES `pricing_configs`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `promotion_plans` ADD CONSTRAINT `promotion_plans_promotionId_fkey` FOREIGN KEY (`promotionId`) REFERENCES `promotions`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `promotion_plans` ADD CONSTRAINT `promotion_plans_planId_fkey` FOREIGN KEY (`planId`) REFERENCES `pricing_plans`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
