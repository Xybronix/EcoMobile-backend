...
class EmailService {
    constructor() {
        this.transporter = nodemailer_1.default.createTransport({
            ...
            secure: config_1.config.email.secure, // true for 465, false for other ports
            auth: {
     ...
     */
    generateWelcomeEmail(firstName, _lang, translations) {
        ...
        const html = this.generateEmailTemplate({
            ...
            message,
            ctaText,
            ctaUrl: `${config_1.config.frontendUrl}/mobile/login`,
     ...
     */
    generatePasswordResetEmail(firstName, resetToken, _lang, translations) {
        ...
        const html = this.generateEmailTemplate({
            ...
            message,
            ctaText,
            ctaUrl: `${config_1.config.frontendUrl}/mobile/reset-password?token=${resetToken}`,
            footerText: translations.email.footer_text,
     ...
     */
    generateRideCompletedEmail(firstName, rideDetails, _lang, translations) {
        ...
        const html = this.generateEmailTemplate({
            ...
            message,
            ctaText,
            ctaUrl: `${config_1.config.frontendUrl}/mobile/ride-history`,
            footerText: translations.email.footer_text,
        });
        return { subject, html };
    }
     ...
     */
    generateDepositEmail(firstName, amount, balance, _lang, translations) {
        ...
        const html = this.generateEmailTemplate({
            ...
            message,
            ctaText,
            ctaUrl: `${config_1.config.frontendUrl}/mobile/wallet`,
            footerText: translations.email.footer_text,
        });
        return { subject, html };
    }
     ...
     */
    generatePromotionEmail(firstName, promotionData, _lang, translations) {
        ...
        const html = this.generateEmailTemplate({
            ...
            message,
            ctaText,
            ctaUrl: promotionData.ctaUrl || config_1.config.frontendUrl,
            footerText: translations.email.footer_text,
        });
        return { subject, html };
    }
     ...
     */
    generateIncidentResolvedEmail(firstName, incidentId, _lang, translations) {
        ...
        const html = this.generateEmailTemplate({
            ...
            message,
            ctaText,
            ctaUrl: `${config_1.config.frontendUrl}/mobile/profile`,
            footerText: translations.email.footer_text,
        });
        return { subject, html };
    }
     ...
     */
    generateReviewSubmittedEmail(firstName, lastName, _lang, translations) {
        ...
        const html = this.generateEmailTemplate({
            ...
            message,
            ctaText,
            ctaUrl: `${config_1.config.frontendUrl}/mobile/services`,
            footerText: translations.email.footer_text,
        });
        return { subject, html };
    }
     ...
     */
    generateNewReviewNotificationEmail(review, _lang, translations) {
        ...
        const html = this.generateEmailTemplate({
            ...
            message,
            ctaText,
            ctaUrl: `${config_1.config.frontendUrl}/admin/reviews`,
            footerText: translations.email.footer_text,
        });
        return { subject, html };
    }
